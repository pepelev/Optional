...
public static partial class AsyncStreamExtensions
{
    ...
    public sealed class FirstOrNone_Should
    {
        public static bool[] Booleans => new[] { true, false };

        private readonly bool continueOnCapturedContext;

        public FirstOrNone_Should(bool continueOnCapturedContext)
        {
        ...
        public static TestCaseData[] Cases => new[]
        {
            ...
            Case("Many_Elements_Sequence", new[] { 2, -5, 15 }).Returns(2.Some())
        };
        ...
        {
            var result = arguments.ToAsync().FirstOrNoneAsync(continueOnCapturedContext: continueOnCapturedContext);
        ...
        public void Pass_CancellationToken_To_Underlying()
        {
            ...
            Assert.CatchAsync<OperationCanceledException>(
                () => mockSequence.FirstOrNoneAsync(mockSequence.Token, continueOnCapturedContext)
            );
        }
    }
}
